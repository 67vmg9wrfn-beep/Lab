...
- 标题：It’s complicated: characterizing the time-varying relationship
- 作者：between cell phone mobility and COVID-19 spread in the US
- 年份 / 期刊 / 会议：2021 / 论文未说明
- DOI / arXiv：论文未说明
- 本地路径：/Users/codex/Lab/01_monitoring/industry/01-apple/2021-11-18_covid-mobility.pdf
- 关键词标签：可穿戴感知, 机器学习, 论文自动分析

## 1️⃣ 一句话总结

- 论文围绕可穿戴感知问题提出方法并给出实验结果，显示出一定性能改进或应用价值（具体边界需复核原文表格与附录）。
