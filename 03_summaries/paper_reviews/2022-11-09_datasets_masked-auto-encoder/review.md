...
- 标题：Hsiang-Yun Sherry Chien, Hanlin Goh, Christopher M. Sandino, Joseph Y. Cheng
- 作者：has been a challenge due to the small data-sets and difﬁculty to obtain labels.
- 年份 / 期刊 / 会议：2022 / arXiv
- DOI / arXiv：论文未说明
- 本地路径：/Users/codex/Lab/01_monitoring/industry/01-apple/2022-11-09_masked-auto-encoder.pdf
- 关键词标签：睡眠监测, 机器学习, 论文自动分析

## 1️⃣ 一句话总结

- 论文围绕睡眠监测问题提出方法并给出实验结果，显示出一定性能改进或应用价值（具体边界需复核原文表格与附录）。
