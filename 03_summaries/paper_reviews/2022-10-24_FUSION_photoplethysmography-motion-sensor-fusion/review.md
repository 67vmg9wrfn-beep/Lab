...
- 标题：FUSION-ID: A PHOTOPLETHYSMOGRAPHY AND MOTION SENSOR FUSION
- 作者：FUSION-ID: A PHOTOPLETHYSMOGRAPHY AND MOTION SENSOR FUSION
- 年份 / 期刊 / 会议：2022 / IEEE（具体会议信息待核对）
- DOI / arXiv：论文未说明
- 本地路径：/Users/codex/Lab/01_monitoring/industry/01-apple/2022-10-24_photoplethysmography-motion-sensor-fusion.pdf
- 关键词标签：心血管/生理信号, 机器学习, 论文自动分析

## 1️⃣ 一句话总结

- 论文围绕心血管/生理信号问题提出方法并给出实验结果，显示出一定性能改进或应用价值（具体边界需复核原文表格与附录）。
...
- 核心结果：
- accuracy of 95%
- accuracy gain over 5 second inputs (95%
- 消融实验：论文未说明
- 泛化能力验证：论文未说明
